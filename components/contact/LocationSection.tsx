...
export default function LocationSection() {
  return (
    <section id="location" className="py-12 md:py-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-10">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#111827] mb-2 sm:mb-3">{SITE_NAME}</h2>
          <p className="text-[#6B7280] text-base md:text-lg">Our Location — Near Manipal University Jaipur</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 md:gap-8 items-start">
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100">
              <h3 className="font-bold text-[#111827] mb-2 sm:mb-3 text-base sm:text-lg">Address</h3>
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100">
              <h3 className="font-bold text-[#111827] mb-2 sm:mb-3 text-base sm:text-lg">Nearby Landmarks</h3>
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#2563EB] text-white font-semibold hover:bg-[#1d4ed8] transition-colors min-h-[48px]"
            >
              <Navigation size={18} />
              Get Directions
            </a>
