...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="py-12 md:py-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-8 md:gap-10 items-center">
          {/* Image */}
          <motion.div {...animateLeft} className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: '16/10', minHeight: 220 }}>
            <Image
          ...
          {/* Text */}
          <motion.div {...animateRight} className="flex flex-col gap-4">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.title} className="flex gap-3">
                  <span className="mt-1.5 h-2 w-2 rounded-full bg-[#2563EB] shrink-0" />
